...
namespace BookShop.Controllers
{
	...
	public class KhachHangController : Controller
	{
		...
		public KhachHangController(BookShopDbContext context, IHttpContextAccessor httpContextAccessor, IMailLogic mailLogic)
		{
			_context = context;
		...
		public async Task<IActionResult> DatHang(DatHang datHang)
		{
			...
			else
			{
				...
				try
				{
					...
					mailInfo.Subject = "Đặt hàng thành công tại BookShop.Com.Vn";
