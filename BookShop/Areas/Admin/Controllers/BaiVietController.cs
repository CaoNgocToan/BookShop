...
namespace BookShop.Areas.Admin.Controllers
{
	...
	public class BaiVietController : Controller
    {
		...
		public BaiVietController(BookShopDbContext context, IHttpContextAccessor httpContextAccessor)
		{
			_context = context;
        ...
        {
            var BookShopDbContext = _context.BaiViet.Include(b => b.ChuDe).Include(b => b.NguoiDung).OrderByDescending(r => r.NgayDang);
