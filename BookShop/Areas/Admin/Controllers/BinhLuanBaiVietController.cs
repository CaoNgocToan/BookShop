...
namespace BookShop.Areas.Admin.Controllers
{
	...
	public class BinhLuanBaiVietController : Controller
    {
		...
		public BinhLuanBaiVietController(BookShopDbContext context, IHttpContextAccessor httpContextAccessor)
        {
            _context = context;
        ...
        {
            var BookShopDbContext = _context.BinhLuanBaiViet.Include(b => b.BaiViet).Include(b => b.NguoiDung).OrderByDescending(r => r.NgayDang);
